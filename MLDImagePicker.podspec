...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/therealmyluckyday/image-picker"
  ...
  s.author             = { "Peter Stajger" => "pstajger@inloop.com" }
  ...
  s.source       = { :git => "https://github.com/therealmyluckyday/image-picker.git", :tag => "#{s.version}" }
